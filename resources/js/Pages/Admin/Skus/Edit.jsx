...
export default function Edit({ product, sku }) {
    ...
    return (
        <AdminLayout>
            <Head title={`Редактировать оттенок - ${product.name}`} />
            ...
            <div className="mb-8">
                ...
                <h1 className="font-serif text-4xl italic text-[#3D2B1F]">Редактировать оттенок</h1>
            ...
            <div className="bg-white p-8 shadow-sm border border-[#3D2B1F]/5 max-w-4xl">
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="pt-10">
                        ...
                        >
                            {processing ? 'Сохранение...' : 'Обновить оттенок'}
                        </button>
                    </div>
                </form>
            </div>
