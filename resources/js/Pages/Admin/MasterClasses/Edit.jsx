...
export default function Edit({ masterClass }) {
    // Format date for datetime-local input (YYYY-MM-DDTHH:mm)
    const formattedDate = masterClass.date_time 
    ...
    return (
        <AdminLayout>
            <Head title="Редактировать мастер-класс" />
            ...
            <div className="mb-8">
                ...
                <h1 className="font-serif text-4xl italic text-[#3D2B1F]">Редактировать МК</h1>
            </div>
            ...
            <div className="bg-white p-8 shadow-sm border border-[#3D2B1F]/5 max-w-3xl">
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="pt-6">
                        ...
                        >
                            {processing ? 'Сохранение...' : 'Обновить мастер-класс'}
                        </button>
                    </div>
                </form>
            </div>
