    ...
    return (
        <AdminLayout>
            ...
            <div className="mb-8">
                ...
                <h1 className="font-serif text-4xl italic text-[#3D2B1F]">Создать товар</h1>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <label className="block text-[#3D2B1F] text-[10px] uppercase tracking-[0.2em] font-bold mb-3" htmlFor="composition">
                            Состав (будет отображаться в раскрывающемся списке)
                        </label>
                        <textarea
                            id="composition"
                            ...
                            className="w-full border-[#3D2B1F]/20 focus:border-[#D4AF37] focus:ring-0 text-[#3D2B1F] placeholder-gray-400 p-3"
                            rows="3"
                            placeholder="Например: Aqua, Glycerin, Retinol..."
                        ></textarea>
